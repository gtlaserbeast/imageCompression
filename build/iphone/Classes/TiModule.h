...
/**
 The base class for all tiimagefactory modules
 */
...
/**
 tiimagefactory Platform calls this method on startup.
 */
-(void)startup;

/**
 tiimagefactory Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 tiimagefactory Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 tiimagefactory Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 tiimagefactory Platform calls this method on resume.
 @param sender The sender of the event.
 */
