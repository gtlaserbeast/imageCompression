...
//@interface tiimagefactoryObject : NSObject
//@end

@interface tiimagefactoryObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[tiimagefactoryObject class]])
		{
			for (NSString *key in [[(tiimagefactoryObject*)o modules] allKeys])
			{
