...
@interface tiimagefactoryObject : KrollCoverageObject {
#else
@interface tiimagefactoryObject : KrollObject {
#endif
@private
...
extern NSString * tiimagefactory$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	tiimagefactoryObject *_tiimagefactory;
    KrollObject* console;
	BOOL shutdown;
