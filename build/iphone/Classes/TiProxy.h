...
//Rare exceptions to indicate a bug in the _tiimagefactory code (Eg, function that a subclass should have implemented)
...
/**
 The base class for tiimagefactory proxies.
 */
