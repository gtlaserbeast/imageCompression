...
/**
 Base class for all tiimagefactory views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the tiimagefactory view hierarchy (such as wrapped iOS UIViews) was touched.
