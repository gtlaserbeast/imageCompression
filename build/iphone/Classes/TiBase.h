...
// in simulator we redefine to format for tiimagefactory Developer console
...
{\
	NSString * exceptionName = [@"org.tiimagefactory." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tiimagefactory";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UItiimagefactoryNativeItemNone = -1, 
	UItiimagefactoryNativeItemSpinner = -2,
	UItiimagefactoryNativeItemProgressBar = -3,
	
	UItiimagefactoryNativeItemSlider = -4,
	UItiimagefactoryNativeItemSwitch = -5,
	UItiimagefactoryNativeItemMultiButton = -6,
	UItiimagefactoryNativeItemSegmented = -7,
	
	UItiimagefactoryNativeItemTextView = -8,
	UItiimagefactoryNativeItemTextField = -9,
	UItiimagefactoryNativeItemSearchBar = -10,
	
	UItiimagefactoryNativeItemPicker = -11,
	UItiimagefactoryNativeItemDatePicker = -12,
	
	UItiimagefactoryNativeItemInfoLight = -13,
	UItiimagefactoryNativeItemInfoDark = -14,
	
	UItiimagefactoryNativeItemDisclosure = -15,
	
	UItiimagefactoryNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all tiimagefactory instances of
